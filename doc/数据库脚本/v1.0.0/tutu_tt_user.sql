...
CREATE TABLE `tt_user` (
  ...
  `salt` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '密码掩值',
  `amount` decimal(10,2) DEFAULT '0.00' COMMENT '金额',
  `portrait` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像',
  `gender` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT '保密' COMMENT '性别：\n保密、男、女',
