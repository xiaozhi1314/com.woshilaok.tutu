...
--
-- Table structure for table `tt_resources`
--

DROP TABLE IF EXISTS `tt_resources`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_resources` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) DEFAULT '1' COMMENT '资源类型',
  `sha1` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '哈希值',
  `md5` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'md5值',
  `domain` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '域名',
  `uri` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '资源地址',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资源表';
