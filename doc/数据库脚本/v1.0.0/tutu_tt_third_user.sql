...
--
-- Table structure for table `tt_third_user`
--

DROP TABLE IF EXISTS `tt_third_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_third_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) DEFAULT NULL COMMENT '用户id',
  `unionid` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '第三方唯一id',
  `uuid` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '第三方id',
